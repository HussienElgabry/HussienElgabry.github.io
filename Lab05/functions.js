...
const reduceExample = (...arr)=>{return arr.reduce((accumulator,elem)=>{return accumulator*elem})};
...
console.log("Expected output of maxOfThree(1,11,111) is 44 "+myFunctionTest(111, ()=>maxOfThree( 1,11, 111)));
console.log("Expected output of maxOfThree(55,555,5) is 55 "+myFunctionTest(555, ()=>maxOfThree( 55,555, 5)));
